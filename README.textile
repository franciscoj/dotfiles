...
* dotfiles for Rubygems, RDoc, IRB, Ruby on Rails IRB and GIT
* dotfiles for vim including "NERD_tree plugin":http://github.com/scrooloose/nerdtree, "snipMate":http://github.com/msanders/snipmate.vim, some "snippets":http://github.com/scrooloose/snipmate-snippets for it and "textile.vim":http://github.com/timcharper/textile.vim plugin
