-- Took these from
-- https://github.com/mattr-/dotfiles/blob/6973593e6dcd882150a3321091f1fe64a7dc3619/home/.hammerspoon/init.lua
...
local function mini_right(window, screen)
	local max = screen:fullFrame()
